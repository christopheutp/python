...
# adresses = [
#     {"numéro de voie" : 233,"complément" : "bis"},
#     {"numéro de voie" : 45,"complément" : "Appt"}
#     ]


def input_adress():
    adress = {}
    adress["N° de voie"] = input("Saisir N° de voie : ")
    adress["Complément"] = input("Saisir Complément  : ")
    adress["Intitulé"] = input("Saisir Intitulé : ")
    adress["Commune"] = input("Saisir Commune : ")
    adress["Code postal"] = input("Saisir Code postal: ")
    return adress
